...
class ForeastAsyncTask extends AsyncTask<String,Void,String[]> {
    ...
    public ForeastAsyncTask(ArrayAdapter<String> mForecastAdapter) {
        this.mForecastAdapter = mForecastAdapter;
    }

    private static final String LOG_TAG = ForeastAsyncTask.class.getSimpleName();
    ...
    protected String[] doInBackground(String... strings) {
        ...
        Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                ...
                .build();
        try {
            return getWeatherDataFromJson(getJsonString(builtUri.toString()), numDays);
